...
function CareerStatsTable({playerID, teamID}){
    ...
    return(
        <div className = 'Career-Stats'>
                        <div className = 'Career-Table-Header'>
                            ...
                            {/* <div className = 'Career-Table-Team-Header-Span-Div'><span className = 'Career-Table-Header-Span'>League</span></div> */}
                        ...
                        {isLoaded ? careerData.map(career => {
                        return <div key = {career.season+career.team.name} className = 'Career-Table-Season-Row'>
                            ...
                            {/* <div className = 'Career-Table-Season-Row-Highlight-Team-Div'><span className = 'Career-Table-Season-Row-Highlight-Span'>{career.league.name}</span></div> */}
